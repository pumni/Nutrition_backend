...
| Provider outage exhausts API capacity | Medium | High | 5 s fixed timeout, one retry maximum, bounded response stream, provider/model circuit breaker | Tune with staging latency/error telemetry and alerting | Backend owner |
