...
Derived from: `crates/adapters/src/fixture.rs`, `crates/adapters/src/hosted_parser.rs`, `docs/HOSTED_PARSER.md`, `docs/FOUNDATION_DECISIONS.md`, `docs/RISK_REGISTER.md`, `nutrition_backend_blueprint_v1.0/06_FOOD_RESOLUTION_AND_LLM_SPEC.md`, `nutrition_backend_blueprint_v1.0/16_VIETNAMESE_MEAL_BENCH_SPEC.md`, `nutrition_backend_blueprint_v1.0/12_ARCHITECTURE_DECISION_RECORDS.md`
