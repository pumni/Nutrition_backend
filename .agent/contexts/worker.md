...
Derived from: `crates/worker/src/main.rs`, `crates/persistence-postgres/src/ops_repository.rs`, `docs/FOUNDATION_DECISIONS.md`, `docs/SECURITY_AND_OPERATIONS.md`, `nutrition_backend_blueprint_v1.0/08_API_AND_RUNTIME_ARCHITECTURE.md`, `nutrition_backend_blueprint_v1.0/09_TESTING_EVALUATION_AND_OBSERVABILITY.md`, `nutrition_backend_blueprint_v1.0/12_ARCHITECTURE_DECISION_RECORDS.md`
