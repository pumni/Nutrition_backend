...
Derived from: `crates/api-http/src/main.rs`, `docs/FOUNDATION_DECISIONS.md`, `docs/SECURITY_AND_OPERATIONS.md`, `nutrition_backend_blueprint_v1.0/08_API_AND_RUNTIME_ARCHITECTURE.md`, `nutrition_backend_blueprint_v1.0/10_SECURITY_PRIVACY_AND_PRODUCT_SAFETY.md`, `nutrition_backend_blueprint_v1.0/12_ARCHITECTURE_DECISION_RECORDS.md`
